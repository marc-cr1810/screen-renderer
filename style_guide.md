# Screen Renderer C++ Code Style Guide

This guide describes the conventions and best practices for writing C++ code in the Screen Renderer project, based on analysis of the project's `.cpp` and `.hpp` files.
...
- **Namespaces:** Use lowercase (e.g., `namespace screen_renderer`).
...
Follow these conventions for all C++ code in Screen Renderer to ensure consistency, readability, and maintainability.
